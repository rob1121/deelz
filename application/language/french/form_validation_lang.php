...
$lang['is_unique'] 				= "Votre %s est déjà inscrit sur notre site, vérifiez vos emails pour retrouver votre code d'accès.";//vous pouvez vous connecter en <a href='".base_url('users/signin')."'>cliquant ici</a>.";
