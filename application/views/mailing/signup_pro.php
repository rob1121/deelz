                                                                                                ...
                                                                                                <tbody><tr>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td style="font-size:18px;font-family:Arial,Helvetica,sans-serif; color:#999; font-weight:normal; text-align:center;">
                                                                                                            ...
                                                                                                            <span style="color:#999; font-weight:normal;"><?php echo lang('mail_signup_pro_l1') ?></span>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td height="10"></td>
                                                                                            ...
                                                                                            <table border="0" valign="top" cellspacing="0" cellpadding="0" width="100%" align="left" class="rnb-col-1">
                                                                                                ...
                                                                                                <tbody><tr>
                                                                                                        <td style="font-size:14px; font-family:Arial,Helvetica,sans-serif, sans-serif; color:#555;">
                                                                                                            <div>
                                                                                                                <?php echo lang('mail_signup_pro_l2') ?>
                                                                                                            </div>
                                                                                                            <div>&nbsp;</div>

                                                                                                            <div><strong><u><?php echo lang('mail_signup_pro_l3') ?></u></strong></div>

                                                                                                            <div><br>
                                                                                                                    <?php echo lang('mail_signup_pro_l4') ?> :&nbsp;<?php echo $email ?></div>

                                                                                                            <div>&nbsp;</div>

                                                                                                            <div><?php echo lang('mail_signup_pro_l5') ?> :&nbsp;<?php echo $password ?></div>

                                                                                                            <div>&nbsp;</div>

                                                                                                            <div>&nbsp;</div>

                                                                                                            <div><?php echo lang('mail_signup_pro_l6') ?></div>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                </tbody></table>
