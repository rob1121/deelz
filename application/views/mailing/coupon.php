                                                                                                ...
                                                                                                <tbody><tr>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td style="font-size:18px;font-family:Arial,Helvetica,sans-serif; color:#999; font-weight:normal; text-align:center;">
                                                                                                            ...
                                                                                                            <span style="color:#999; font-weight:normal;"><?php echo lang('mail_coupon_l1') ?></span>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td height="10"></td>
                                                                                            ...
                                                                                            <table border="0" valign="top" cellspacing="0" cellpadding="0" width="100%" align="left" class="rnb-col-1">
                                                                                                ...
                                                                                                <tbody><tr>
                                                                                                        <td style="font-size:14px; font-family:Arial,Helvetica,sans-serif, sans-serif; color:#555;">
                                                                                                            ...
                                                                                                            <div>
                                                                                                                <?php echo lang('mail_coupon_l2') ?>
                                                                                                                <br /><br />
                                                                                                                <?php echo lang('mail_coupon_l3') ?> <a href='<?php echo base_url('users/coupon/' . $order_id) ?>'><?php echo lang('mail_coupon_l4') ?></a>
                                                                                                                <br /><br />
                                                                                                                <?php echo lang('mail_coupon_l5') ?>
                                                                                                            </div>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                </tbody></table>
