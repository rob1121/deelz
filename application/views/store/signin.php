    ...
    <div class="page-container ptb-60">
        <div class="container">
            <section class="sign-area panel p-40">
                <h3 class="sign-title"><?php echo lang('store_signin_l1') ?></h3>
                <div class="row row-rl-0">
                    <div class="col-sm-12 col-md-12 col-left">
                        <form class="p-40" action="" method="post">
                            <?php if(isset($error)) : ?> 
                            <div class="alert alert-danger">
                                <p><?php echo lang('store_signin_l2') ?></p>
                            </div>
                            <?php endif; ?>
                            ...
                            <div class="form-group">
                                <a href="<?php echo base_url('store/renew_password'); ?>" class="forgot-pass-link color-green"><?php echo lang('store_signin_l3') ?></a>
                            </div>
                            <div class="custom-checkbox mb-20">
                                <input type="checkbox"  id="sess_expiration" name="sess_expiration" value="1" checked>
                                <label class="color-mid"><?php echo lang('store_signin_l4') ?></label>
                            </div>
                            <button type="submit" class="btn btn-block btn-lg"><?php echo lang('store_signin_l5') ?></button>
                        </form>
                        <div class="text-center color-mid">
                            <?php echo lang('store_signin_l6') ?>
                        </div>
