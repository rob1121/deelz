...
admin = {
    ...
    loadCmsContent: function (controller, method) {
        $.ajax({
            url: $('#base_url').val() + "ajax/loadCmsContent/" + controller + "/" + method,
            dataType: 'json'
        }).complete(function (res) {
            if (res.responseJSON != undefined && res.responseJSON != 'false' && res.responseJSON != false) {
    ...
    loadCategories: function () {
        $.ajax({
            ...
            if (res.responseJSON != undefined && res.responseJSON != 'false' && res.responseJSON != false) {
                ...
                $('#categoriesList').html('<div class="alert alert-error">Impossible de charger les catégories.</div>');
            }
        }).error(function () {
            $('#categoriesList').html('<div class="alert alert-error">Impossible de charger les catégories.</div>');
        });
